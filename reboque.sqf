...
if(hasInterface) then {
	...
	player addAction ["Pegar corda de reboque", { 
	...
	player addAction ["Guardar cordas de reboque", { 
	...
	player addAction ["Anexar cordas para rebocar", { 
	...
	player addAction ["Não é possível anexar cordas de reboque", { 
		hint "O seu veículo não é forte o suficiente para rebocar isso. Localizar um veículo maior!"; 
	...
	player addAction ["Largar cordas de reboque", { 
